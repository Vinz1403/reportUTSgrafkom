...
public class SphereJu extends Circle{

    List<Integer> index;
    int ibo;

    public SphereJu(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f center, Vector3f radius) {
