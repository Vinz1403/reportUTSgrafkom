...
public class halfSphere extends Circle {
    ...
    public halfSphere(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f center, Vector3f radius) {
    ...
    public void createhalfSphere() {
        ...
        float sectorStep = (float) (2.0f * Math.PI) / sectorCount; //sector count
